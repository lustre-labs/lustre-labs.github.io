(() => {
  ...
  core_default.registerLanguage("sh", shell);
  core_default.registerLanguage("shell", shell);
  core_default.registerLanguage("gleam", gleam);
  core_default.highlightAll();
  var base = "/";
  var stdlib = "https://hexdocs.pm/gleam_stdlib/gleam/";
  var links = {
  ...
  function gleam(hljs) {
    const KEYWORDS2 = "as assert case const fn if import let panic use opaque pub todo type";
    const STRING = {
      className: "string",
      variants: [{ begin: /"/, end: /"/ }],
